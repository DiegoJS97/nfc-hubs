...
- [x] T034 [P] Write `tests/a11y/wcag.spec.ts` running axe against both hubs in both registers, asserting zero contrast and target-size violations (SC-010, FR-023)
